        ...
        <div class="container">
            <div class="single-grid">
                <div class="text-center">
                    <section>
                        <iframe width="1170" height="670" :src="blogData.videoSrc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                    </section>
                </div>
