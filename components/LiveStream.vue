      ...
      <modal name="sxySamurai" :width=1600 :height=800 :adaptive=true>
          <div style="padding-bottom: 56.25%; position: relative;">
              <iframe 
                  width="100%" 
                  height="100%" 
                  src="https://player.twitch.tv/?autoplay=false&channel=sxysamurai&parent=www.decayeddojo.com" 
                  frameborder="0" 
      ...
      <modal name="mysticNynja" :width=1600 :height=800 :adaptive=true>
          <div style="padding-bottom: 56.25%; position: relative;">
              <iframe 
                  width="100%" 
                  height="100%" 
                  src="https://player.twitch.tv/?autoplay=false&channel=mysticNynja&parent=www.decayeddojo.com" 
                  frameborder="0" 
                  allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture; fullscreen"  
                  style="position: absolute; top: 0px; left: 0px; width: 100%; height: 100%;"> 
              </iframe>
